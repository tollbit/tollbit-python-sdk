...
_TIMEOUT_ENV = "TOLLBIT_SDK_TIMEOUT"
_DEFAULT_TIMEOUT = 30
...
class Environment:
    ...
    def override(self, **kwargs) -> "Environment":
        ...
        return Environment(
            developer_api_base_url=kwargs.get("developer_api_base_url", self.developer_api_base_url),
...
def env_from_vars() -> Environment:
    ...
    timeout = int(os.getenv(_TIMEOUT_ENV, _DEFAULT_TIMEOUT))
    return Environment(developer_api_base_url=developer_api_base_url, anyio_backend=anyio_backend, timeout=timeout)